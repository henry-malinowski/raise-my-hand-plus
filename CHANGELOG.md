## 2.0.0
- Added a configurable timeout feature ([issue #21](https://github.com/brunocalado/raise-my-hand-plus/issues/20)). Default is 10 seconds.
...
- Replaced xcard image with an SVG to improve initial load time
...
- Repo includes configured i18n-ally support to aid in on going translation efforts
